...
export default function signup() {
    ...
    const signupFunc = async () =>{
        ...
        {
            return alert("error occurred while signing up: " + err);
        }
    }
                ...
                <div className='relative top-[25%]'>
                    <div className='relative flex justify-between bg-gray-800 max-w-prose mx-auto'>
                        <div className='my-[4rem] flex flex-col ml-[4rem] items-center justify-center space-y-[3rem]'>
                            ...
                            <div>
                                <input type="text" id='username' placeholder='username' onChange={(e)=>setCreds({...creds, username:e.target.value})}/>
                            </div>
                            ...
                            <div>
                                <button className='bg-[#01134C] text-white px-[1.2rem] py-[0.2rem] rounded-md' onClick={signupFunc}>Sign up</button>
                            </div>
